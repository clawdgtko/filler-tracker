  ...
  'naruto': {
    ...
    guides: {
      fr: {
        ...
        s2: [
          { ep: 1, type: "must-watch", note: "Début épreuve forêt (S2E1)" },
          { ep: 2, type: "must-watch", note: "Forêt de la mort" },
          { ep: 3, type: "must-watch", note: "Orochimaru apparaît" },
          { ep: 4, type: "must-watch", note: "Naruto vs Orochimaru" },
          { ep: 5, type: "must-watch", note: "Sasuke vs Orochimaru" },
          { ep: 6, type: "must-watch", note: "Lee protège Sakura" },
          { ep: 7, type: "must-watch", note: "Sakura se bat" },
          { ep: 8, type: "must-watch", note: "Formation Ino-Shika-Cho" },
          { ep: 9, type: "must-watch", note: "Gaara cruel" },
          { ep: 10, type: "must-watch", note: "Secret du parchemin" },
          { ep: 11, type: "optional", note: "Filler" },
          { ep: 12, type: "must-watch", note: "9 survivants" },
          { ep: 13, type: "must-watch", note: "Elimination" },
          { ep: 14, type: "optional", note: "Filler" },
          { ep: 15, type: "must-watch", note: "Confrontation" },
          { ep: 16, type: "must-watch", note: "Combat filles" },
          { ep: 17, type: "must-watch", note: "Sakura vs Ino" },
          { ep: 18, type: "must-watch", note: "Temari vs Tenten" },
          { ep: 19, type: "optional", note: "Filler" },
          { ep: 20, type: "must-watch", note: "Secret Naruto" },
          { ep: 21, type: "must-watch", note: "Hinata vs Neji" },
          { ep: 22, type: "must-watch", note: "Discours Naruto" },
          { ep: 23, type: "must-watch", note: "Combat légendaire Gaara vs Lee" },
          { ep: 24, type: "must-watch", note: "8 portes" },
          { ep: 25, type: "must-watch", note: "Lee utilise les 8 portes" },
          { ep: 26, type: "must-watch", note: "Gaara terrifiant" },
          { ep: 27, type: "optional", note: "Filler" }
        ],
        s3: [
          { ep: 1, type: "must-watch", note: "Jiraiya arrive (S3E1)" },
          { ep: 2, type: "must-watch", note: "Invocation" },
          { ep: 3, type: "optional", note: "Filler" },
          { ep: 4, type: "must-watch", note: "Entraînement" },
          { ep: 5, type: "must-watch", note: "Gamabunta" },
          { ep: 6, type: "optional", note: "Filler" },
          { ep: 7, type: "must-watch", note: "Début finales" },
          { ep: 8, type: "must-watch", note: "Hinata vs Neji début" },
          { ep: 9, type: "must-watch", note: "Byakugan complet" },
          { ep: 10, type: "must-watch", note: "Naruto soutient Hinata" },
          { ep: 11, type: "must-watch", note: "Tirage au sort" },
          { ep: 12, type: "skip", note: "Filler - Arc Hokage Battle Royale" },
          { ep: 13, type: "skip", note: "Filler - Arc Hokage Battle Royale" },
          { ep: 14, type: "skip", note: "Filler - Arc Hokage Battle Royale" },
          { ep: 15, type: "skip", note: "Filler - Arc Hokage Battle Royale" },
          { ep: 16, type: "skip", note: "Filler - Arc Hokage Battle Royale" },
          { ep: 17, type: "skip", note: "Filler - Arc Hokage Battle Royale" },
          { ep: 18, type: "skip", note: "Filler - Arc Hokage Battle Royale" },
          { ep: 19, type: "skip", note: "Filler - Arc Hokage Battle Royale" },
          { ep: 20, type: "skip", note: "Filler - Arc Hokage Battle Royale" },
          { ep: 21, type: "skip", note: "Filler - Arc Hokage Battle Royale" },
          { ep: 22, type: "skip", note: "Filler - Arc Hokage Battle Royale" },
          { ep: 23, type: "skip", note: "Filler - Arc Hokage Battle Royale" },
          { ep: 24, type: "skip", note: "Filler - Arc Hokage Battle Royale" },
          { ep: 25, type: "skip", note: "Filler - Arc Hokage Battle Royale" },
          { ep: 26, type: "skip", note: "Filler - Arc Hokage Battle Royale" }
        ],
        s4: [
          { ep: 1, type: "must-watch", note: "Retour canon important (S4E1)" },
          { ep: 2, type: "must-watch", note: "Troisième Hokage scellé" },
          { ep: 3, type: "must-watch", note: "Retour au canon" },
          { ep: 4, type: "must-watch", note: "Kakashi vs Itachi" },
          { ep: 5, type: "must-watch", note: "Jiraiya entraîne Naruto" },
          { ep: 6, type: "must-watch", note: "Sasuke vs Itachi" },
          { ep: 7, type: "must-watch", note: "Histoire Uchiha" },
          { ep: 8, type: "must-watch", note: "Nouvel entraînement" },
          { ep: 9, type: "must-watch", note: "Rasengan training" },
          { ep: 10, type: "must-watch", note: "Suite entraînement" },
          { ep: 11, type: "must-watch", note: "Histoire Tsunade" },
          { ep: 12, type: "must-watch", note: "Orochimaru vs Jiraiya" },
          { ep: 13, type: "must-watch", note: "Collier de Tsunade" },
          { ep: 14, type: "must-watch", note: "Décision Tsunade" },
          { ep: 15, type: "must-watch", note: "Combat début" },
          { ep: 16, type: "must-watch", note: "Rasengan complet" },
          { ep: 17, type: "must-watch", note: "Tsunade devient Hokage" },
          { ep: 18, type: "must-watch", note: "Combat 3 Sannin" },
          { ep: 19, type: "skip", note: "Filler" },
          { ep: 20, type: "skip", note: "Filler" },
          { ep: 21, type: "skip", note: "Filler" },
          { ep: 22, type: "must-watch", note: "Départ Sasuke" },
          { ep: 23, type: "optional", note: "Filler amusant - visage Kakashi" },
          { ep: 24, type: "skip", note: "Filler arc Tea" },
          { ep: 25, type: "skip", note: "Filler arc Tea" },
          { ep: 26, type: "skip", note: "Filler arc Tea" },
          { ep: 27, type: "skip", note: "Filler arc Tea" },
          { ep: 28, type: "skip", note: "Filler arc Tea" }
        ],
        s5: [
          { ep: 1, type: "must-watch", note: "Début combat final Naruto vs Sasuke" },
          { ep: 2, type: "must-watch", note: "Combat Naruto vs Sasuke" },
          { ep: 3, type: "must-watch", note: "Sasuke part" },
          { ep: 4, type: "must-watch", note: "Équipe de récupération" },
          { ep: 5, type: "must-watch", note: "Combat début" },
          { ep: 6, type: "must-watch", note: "Problèmes dans l'équipe" },
          { ep: 7, type: "must-watch", note: "Choji vs Jirobo" },
          { ep: 8, type: "must-watch", note: "Choji utilise pilules" },
          { ep: 9, type: "must-watch", note: "Kiba vs Sakon" },
          { ep: 10, type: "must-watch", note: "Kiba combat" },
          { ep: 11, type: "must-watch", note: "Sasuke dans le vase" },
          { ep: 12, type: "must-watch", note: "Kimimaro apparaît" },
          { ep: 13, type: "must-watch", note: "Nouveau ennemi" },
          { ep: 14, type: "must-watch", note: "Gaara vs Kimimaro" },
          { ep: 15, type: "must-watch", note: "Combats multiples" },
          { ep: 16, type: "must-watch", note: "Shikamaru stratège" },
          { ep: 17, type: "must-watch", note: "Lee vs Kimimaro" },
          { ep: 18, type: "must-watch", note: "Lee boit alcool" },
          { ep: 19, type: "must-watch", note: "Gaara sauve Lee" },
          { ep: 20, type: "must-watch", note: "Combat légendaire Gaara vs Kimimaro" },
          { ep: 21, type: "must-watch", note: "Kimimaro technique finale" },
          { ep: 22, type: "must-watch", note: "Naruto rattrape Sasuke" },
          { ep: 23, type: "must-watch", note: "Flashback Sasuke" },
          { ep: 24, type: "must-watch", note: "Histoire Uchiha" },
          { ep: 25, type: "must-watch", note: "Secrets Sharingan" },
          { ep: 26, type: "must-watch", note: "Naruto vs Sasuke début" },
          { ep: 27, type: "must-watch", note: "Naruto vs Sasuke" },
          { ep: 28, type: "must-watch", note: "Combat final" },
          { ep: 29, type: "must-watch", note: "Sasuke s'en va" },
          { ep: 30, type: "skip", note: "Filler arc Kaima" },
          { ep: 31, type: "skip", note: "Filler arc Kaima" },
          { ep: 32, type: "skip", note: "Filler arc Kaima" },
          { ep: 33, type: "skip", note: "Filler arc Kaima" },
          { ep: 34, type: "skip", note: "Filler arc Kaima" },
          { ep: 35, type: "skip", note: "Filler arc Kaima" },
          { ep: 36, type: "skip", note: "Filler arc Kaima" },
          { ep: 37, type: "skip", note: "Filler arc Kaima" },
          { ep: 38, type: "skip", note: "Filler arc Kaima" },
          { ep: 39, type: "skip", note: "Filler" },
          { ep: 40, type: "skip", note: "Filler" },
          { ep: 41, type: "skip", note: "Filler arc Menma" },
          { ep: 42, type: "skip", note: "Filler arc Menma" },
          { ep: 43, type: "skip", note: "Filler arc Menma" },
          { ep: 44, type: "skip", note: "Filler arc Menma" },
          { ep: 45, type: "skip", note: "Filler arc Menma" },
          { ep: 46, type: "skip", note: "Filler arc Menma" },
          { ep: 47, type: "skip", note: "Filler arc Menma" },
          { ep: 48, type: "skip", note: "Filler clip show" },
          { ep: 49, type: "skip", note: "Filler clip show" },
          { ep: 50, type: "skip", note: "Filler arc Raiga" },
          { ep: 51, type: "skip", note: "Filler arc Raiga" },
          { ep: 52, type: "skip", note: "Filler arc Raiga" },
          { ep: 53, type: "skip", note: "Filler arc Raiga" },
          { ep: 54, type: "skip", note: "Filler arc Raiga" },
          { ep: 55, type: "skip", note: "Filler clip show" },
          { ep: 56, type: "skip", note: "Filler clip show" },
          { ep: 57, type: "skip", note: "Filler clip show" },
          { ep: 58, type: "skip", note: "Filler arc Raiga" },
          { ep: 59, type: "skip", note: "Filler arc Raiga" },
          { ep: 60, type: "skip", note: "Filler clip show" },
          { ep: 61, type: "skip", note: "Filler clip show" },
          { ep: 62, type: "skip", note: "Filler arc curry" },
          { ep: 63, type: "skip", note: "Filler arc curry" },
          { ep: 64, type: "skip", note: "Filler arc curry" },
          { ep: 65, type: "skip", note: "Filler arc curry" },
          { ep: 66, type: "skip", note: "Filler arc curry" },
          { ep: 67, type: "skip", note: "Filler arc mer" },
          { ep: 68, type: "skip", note: "Filler arc mer" },
          { ep: 69, type: "skip", note: "Filler arc mer" },
          { ep: 70, type: "skip", note: "Filler arc mer" },
          { ep: 71, type: "skip", note: "Filler arc postier" },
          { ep: 72, type: "skip", note: "Filler arc postier" },
          { ep: 73, type: "skip", note: "Filler arc postier" },
          { ep: 74, type: "skip", note: "Filler arc postier" },
          { ep: 75, type: "skip", note: "Filler arc postier" },
          { ep: 76, type: "skip", note: "Filler arc postier" },
          { ep: 77, type: "skip", note: "Filler arc postier" },
          { ep: 78, type: "skip", note: "Filler arc Onbaa" },
          { ep: 79, type: "skip", note: "Filler arc Onbaa" },
          { ep: 80, type: "skip", note: "Filler arc Onbaa" },
          { ep: 81, type: "skip", note: "Filler déménagement" },
          { ep: 82, type: "skip", note: "Filler déménagement" },
          { ep: 83, type: "skip", note: "Filler déménagement" },
          { ep: 84, type: "skip", note: "Filler arc marchands" },
          { ep: 85, type: "skip", note: "Filler arc marchands" },
          { ep: 86, type: "skip", note: "Filler arc marchands" },
          { ep: 87, type: "skip", note: "Filler arc marchands" },
          { ep: 88, type: "skip", note: "Filler arc marchands" },
          { ep: 89, type: "skip", note: "Filler arc marchands" },
          { ep: 90, type: "skip", note: "Filler arc marchands" },
          { ep: 91, type: "skip", note: "Filler arc marchands" },
          { ep: 92, type: "skip", note: "Filler arc marchands" },
          { ep: 93, type: "skip", note: "Filler arc marchands" },
          { ep: 94, type: "skip", note: "Filler arc marchands" },
          { ep: 95, type: "skip", note: "Filler arc marchands" },
          { ep: 96, type: "skip", note: "Filler arc marchands" },
          { ep: 97, type: "skip", note: "Filler arc marchands" },
          { ep: 98, type: "skip", note: "Filler arc marchands" },
          { ep: 99, type: "skip", note: "Filler arc Kurenai" },
          { ep: 100, type: "skip", note: "Filler arc Kurenai" },
          { ep: 101, type: "skip", note: "Filler arc Kurenai" },
          { ep: 102, type: "skip", note: "Filler arc Kurenai" },
          { ep: 103, type: "skip", note: "Filler arc Kurenai" },
          { ep: 104, type: "skip", note: "Filler arc Kurenai" },
          { ep: 105, type: "skip", note: "Filler arc Kurenai" },
          { ep: 106, type: "skip", note: "Filler arc Kurenai" },
          { ep: 1, type: "skip", note: "Filler arc Kurenai" },
          { ep: 2, type: "skip", note: "Filler arc Kurenai" },
          { ep: 3, type: "skip", note: "Filler arc Kurenai" },
          { ep: 4, type: "skip", note: "Filler arc Kurenai" },
          { ep: 5, type: "skip", note: "Filler arc mémoire" },
          { ep: 6, type: "skip", note: "Filler arc mémoire" },
          { ep: 7, type: "skip", note: "Filler arc mémoire" },
          { ep: 8, type: "must-watch", note: "Fin Naruto - Début Shippuden" }
        ]
      }
    }
  },
